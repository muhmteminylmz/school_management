...
public class StudentRequest extends BaseUserRequest {
    ...
    @Pattern(regexp="\\A(?!\\s*\\Z).+", message="Your mother name must consist of the characters a-z and 8-9.")
    private String motherName;

    @NotNull(message = "Please enter father name")
    @Size(min = 2,max = 16,message = "Your father name should be at least 2 chars")
    @Pattern(regexp="\\A(?!\\s*\\Z).+", message="Your father name must consist of the characters a-z and 8-9.")
